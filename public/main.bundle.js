...
var ChatComponent = (function () {
    ...
    ChatComponent.prototype.saveUsername = function () {
        ...
        //console.log(this.x);
        this.chatService.saveUsername(this.userInput).subscribe(function (data) {
            //console.log(data['sta']);
            // console.log(this.x);
            if (data['sta'] == 'f') {
                //  console.log(data['alert']);
                _this.message1 = data['alert'];
                //  console.log(this.message1);
                _this.messageClass = 'alert alert-danger';
                _this.userInput = '';
            }
            else if (data['sta'] == 't') {
                _this.message1 = 'Hi ' + _this.x + '!';
                //console.log(this.message1);
                _this.messageClass = 'alert alert-success';
                _this.username = _this.x;
            }
        });
    };
    ChatComponent.prototype.timeNow = function () {
        var d = new Date(), h = (d.getHours() < 10 ? '0' : '') + d.getHours(), m = (d.getMinutes() < 10 ? '0' : '') + d.getMinutes(), s = d.getSeconds();
        var value = h + ':' + m + ':' + s;
        return value;
    };
    __decorate([
...
var ChatService = (function () {
    ...
    ChatService.prototype.sendMessage = function (message, username, time) {
    ...
    ChatService.prototype.getStatus = function () {
    };
